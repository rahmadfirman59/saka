                ...
                <table class="table datatable-primary table-striped table-hover datatable-jquery" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@if(isset($item->penjualan_sum_jumlah)){{ $item->penjualan_sum_jumlah .' '. $item->satuan}}@endif @if(isset($item->sisa_pecahan)&&$item->sisa_pecahan !== 0)({{ $item->sisa_pecahan }} Tablet)@endif</td>
                            <td>{{ $item->stok }}</td>
